...
source "${PWD}"/01-get-system-info/01-get-distribution-name.sh

# shellcheck source=./02-get-package-manager.sh
source "${PWD}"/01-get-system-info/02-get-package-manager.sh

# shellcheck source=./03-get-cpu-info.sh
source "${PWD}"/01-get-system-info/03-get-cpu-info.sh

# shellcheck source=./04-get-memory-info.sh
source "${PWD}"/01-get-system-info/04-get-memory-info.sh
